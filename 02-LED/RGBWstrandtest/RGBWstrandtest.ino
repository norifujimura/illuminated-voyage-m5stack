...
//#define LED_PIN     6
#define LED_PIN     32 //21 or 32 or 33
...
void loop() {
  ...
  colorWipe(strip.Color(200,   100,   100)     , 50); // Red
  colorWipe(strip.Color(  100, 200,   100)     , 50); // Green
  colorWipe(strip.Color(  100,   100, 200)     , 50); // Blue
  colorWipe(strip.Color(  100,   100,   100, 200), 50); // True white (not RGB white)
